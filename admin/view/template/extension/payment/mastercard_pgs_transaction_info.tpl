            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" id="transaction_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="form-info"><a href="<?php echo $url_order; ?>"
                                                      target="_blank"><?php echo $order_id; ?></a></div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div
                            <?php if ($is_authorized || $is_captured || $is_payment) echo ' class="input-group"'; ?>>
                            <?php if ($is_authorized) { ?>
                            <input type="text" class="form-control" name="transaction_amount"
                                   value="<?php echo $amount; ?>"/>
                            <a class="form-submit input-group-addon btn btn-success" href="<?php echo $url_capture; ?>"
                               data-toggle="tooltip" data-original-title="<?php echo $text_capture; ?>"
                               data-confirm-text="<?php echo $text_confirm_capture; ?>"><i class="fa fa-check"></i>&nbsp;<?php echo $button_capture; ?>
                            </a>
                            <a class="form-submit input-group-addon btn btn-danger" href="<?php echo $url_void; ?>"
                               data-toggle="tooltip" data-original-title="<?php echo $text_void; ?>"
                               data-confirm-text="<?php echo $text_confirm_void; ?>"><i
                                        class="fa fa-remove"></i>&nbsp;<?php echo $button_void; ?></a>
                            <?php } else if ($is_captured) { ?>
                            <input type="text" class="form-control" name="transaction_amount"
                                   value="<?php echo $amount; ?>"/>
                            <a class="form-submit input-group-addon btn btn-danger" href="<?php echo $url_refund; ?>"
                               data-toggle="tooltip" data-original-title="<?php echo $text_refund; ?>"
                               data-confirm-text="<?php echo $text_confirm_refund; ?>"><i
                                        class="fa fa-reply"></i>&nbsp;<?php echo $button_refund; ?></a>
                            <a class="form-submit input-group-addon btn btn-danger" href="<?php echo $url_void; ?>"
                               data-toggle="tooltip" data-original-title="<?php echo $text_void; ?>"
                               data-confirm-text="<?php echo $text_confirm_void; ?>"><i
                                        class="fa fa-remove"></i>&nbsp;<?php echo $button_void; ?></a>
