  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-ecc" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ecc" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="ecc_merchant_id" value="<?php echo $ecc_merchant_id; ?>" placeholder="<?php echo $entry_merchant_id; ?>" id="input-merchant_id" class="form-control" />
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-terminal-id"><?php echo $entry_terminal_id; ?></label>
            <div class="col-sm-10">
              <input type="text" name="ecc_terminal_id" value="<?php echo $ecc_terminal_id; ?>" placeholder="<?php echo $entry_terminal_id; ?>" id="input-terminal_id" class="form-control" />
